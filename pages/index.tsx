      ...
      <div className="min-h-screen relative w-full flex text-center px-4 py-10 sm:px-32 grainy">
        ...
        <div className="pb-12 z-[4]">
          <a href="https://basegains.com/">
            <Image src={logo} width={50} height={50} className="w-24 rounded-full border-4 border-black" alt="logo" />
          </a>
        </div>
    ...
    return (
      <div>
        <Head>
          ...
          <meta content="Base Gains" name="description" />
          <link href="/favicon.ico" rel="icon" />
        </Head>
        {/* Dashboard component will be rendered once redirected */}
        <Dashboard />
      </div>
    );
  }
